                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h4 class="page-header">
                            ...
                            Category Management >> <a href="category_management.php">entertainment</a> /
						  <?php
						  if($getdir != '')
						  {
					...
					<div class="col-lg-12">
                        <h4 class="page-header">Upload a file to this folder /Entertainment/<?=$getdir;?></h4>
						<table class="table table-bordered table-hover">
							<thead>
								<tr>
									<th>Videos/Images</th>
							...
							foreach ($itempaths as $path) {
								...
								if(file_exists(ROOTPATH.'/'.$pathname."/".$vfilename[0].".txt"))
								{
									...
									echo "<tr>
										<td><img width='50' height='50' src='/entertainment/".$_GET['dir'].'/'.$vfilename[0].".jpg'></img> <b><i class='fa'> <a href='filedetails.php?dir=".$_GET['dir']."&file=".$vfilename[0]."'>".$vfilename[0]."</a></i></b></td>
										<td>".@date('d M, Y',$path["datemodified"])."</td>
										<td>".format_size($path["size"])."</td>
										<td width='200px'> <a href='viewmediadetails.php?dir=".$_GET['dir']."&file=".$vfilename[0]."'>View</a> | 
										<a href='filedetails.php?dir=".$_GET['dir']."&file=".$vfilename[0]."'>Edit</a> | ".$displaystatus." | <a onclick=deleteMediaFiles('/entertainment/".$_GET["dir"]."','".$vfilename[0]."')>Delete</a>
										</td>
									</tr>";
								}
							}
