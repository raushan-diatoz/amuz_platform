						...
						<div class="panel panel-<?=$cssclass;?>">
							...
							<table id="exampleas" class='table table-bordered display'>
								...
								<tbody>
									...
									if($_GET["val"] == "video")
									{
										$sqld = mysql_query("select custom_var_v4, count(*) as cnt from piwik_log_link_visit_action where custom_var_v5 like '%.mp4' and custom_var_v1 = '".$srlkey."' group by custom_var_v5;");
									...
									if($_GET["val"] == "audio")
									{
										$sqld = mysql_query("select custom_var_v4, count(*) as cnt from piwik_log_link_visit_action where custom_var_v5 like '%.mp3' and custom_var_v1 = '".$srlkey."' group by custom_var_v5;");
