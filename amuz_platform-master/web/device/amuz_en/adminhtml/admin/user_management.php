							...
							$myfile = fopen("db/admin.db", "r") or die("Unable to open file!");
								...
								foreach($nearr as $narr)
								{
									...
									if($narr[0] != '')
									{
										...
										?>
										<tr> 
											<td><?php echo $narr[0];?></td>
											<td><?php echo $narr[1];?></td>
											<td><?php echo $narr[10];?></td>
											<td><?php echo $umange;?></td>
											<td><?php echo $catmange;?></td>
											<td><?php echo $lmange;?></td>
											<td><?php echo $service;?></td>
											<td><?php echo $coupmange;?></td>
											<td><?php echo $skmange;?></td>
											<td><?php echo $dmange;?></td>
