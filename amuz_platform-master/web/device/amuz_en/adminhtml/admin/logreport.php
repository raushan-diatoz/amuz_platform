...
<div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
						...
						<div class="panel panel-<?=$cssclass;?>">
							...
							<table id="examplea" class='table table-bordered display'>
								...
								<tbody>
									...
									if($_GET["val"] == "video")
									{
										$sql = mysqli_query($dblink,"select custom_var_v4, count(*) as cnt from piwik_log_link_visit_action where custom_var_v5 like '%.mp4' group by custom_var_v4;");
										...
										<tr>
											...
											<table class='table table-bordered display'>
												...
												<tbody>";
											$sql1 = mysqli_query($dblink,"select custom_var_v6,custom_var_v7 from piwik_log_link_visit_action where custom_var_v4 = '".$res["custom_var_v4"]."' and custom_var_v5 != ''");
									...
									if($_GET["val"] == "audio")
									{
										$sql = mysqli_query($dblink,"select custom_var_v4, count(*) as cnt from piwik_log_link_visit_action where custom_var_v5 like '%.mp3' group by custom_var_v4 and custom_var_v5 != '';");
									...
									if($_GET["val"] == "image")
									{
										$sql = mysqli_query($dblink,"select custom_var_v5, count(*) as cnt from piwik_log_link_visit_action where custom_var_v5 not like '%.mp4' and custom_var_v5 not like '%.mp3' group by custom_var_v5 and custom_var_v5 != '';");
								...
								<tfoot>
									<tr>
										<td><b>Total</b></td>
										<td><b><?=$tcount;?></b></td>
										<td><b> <?php if(isset($tnum)){array_sum($tnum);}?></b></td>
									</tr>
								</tfoot>
							</table>
							</div>
					...
					<?php
					$sval = 1;
					$sql = mysqli_query($dblink,"select custom_var_v1, count(*) as cnt from piwik_log_link_visit_action group by custom_var_v1;");
					while($res = mysqli_fetch_assoc($sql))
					{
						...
						<div class="panel panel-<?=$cssclass;?>">
							...
							<table id="exampleas" class='table table-bordered display'>
								...
								<tbody>
									...
									if($_GET["val"] == "video")
									{
										$sqld = mysqli_query($dblink,"select custom_var_v4, count(*) as cnt from piwik_log_link_visit_action where custom_var_v5 like '%.mp4' and custom_var_v1 = '".$srlkey."' group by custom_var_v4;");
										
										$tnumd = array();
										while($res = mysqli_fetch_assoc($sqld))
										{
										?>
										<tr>
											<td><?=ucfirst($_GET["val"]);?></td>
									...
									if($_GET["val"] == "audio")
									{
										$sqld = mysql_query($dblink,"select custom_var_v4, count(*) as cnt from piwik_log_link_visit_action where custom_var_v5 like '%.mp3' and custom_var_v1 = '".$srlkey."' group by custom_var_v4;");
									...
									if($_GET["val"] == "ad")
									{
										$sqld = mysqli_query($dblink,"select custom_var_v2, count(*) as cnt from piwik_log_link_visit_action where custom_var_v4 not like '%.jpg' and custom_var_v5 not like '%.mp3' and custom_var_v2 != '' and custom_var_v1 = '".$srlkey."' group by custom_var_v2;");
									...
									if($_GET["val"] == "image")
									{
										$sqld = mysqli_query($dblink,"select custom_var_v5, count(*) as cnt from piwik_log_link_visit_action where custom_var_v5 not like '%.mp4' and custom_var_v5 not like '%.mp3' and custom_var_v1 = '".$srlkey."' group by custom_var_v5;");
