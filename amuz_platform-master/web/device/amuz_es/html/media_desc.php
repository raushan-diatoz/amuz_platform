...
<div class="container">
	...
	if($ntime > $_COOKIE["sesiontimeend_".$nmediafile] && $_COOKIE["sesiontimeend_".$nmediafile] != "")
      ...
      <?php } else {        
		...
		<a id="directbillanchor"> <input type="radio" name="paymentmethod" value="directradio">Direct Billing</a>
		<?php } ?>
               </div>
...
<script type="text/javascript">
 ...
 if(ua == 'iPhone'){
	document.getElementById("directbillanchor").href = "sms:52409&body=hello%20there";
 }else if(ua == 'Linux'){
        document.getElementById("directbillanchor").href = "sms:52409;body=hello%20there";
 }
